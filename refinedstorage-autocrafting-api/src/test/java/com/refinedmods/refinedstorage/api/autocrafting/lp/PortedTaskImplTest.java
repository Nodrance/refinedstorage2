...
import static com.refinedmods.refinedstorage.api.autocrafting.lp.ExternalPatternSinkProviderImpl.sinkKey;
...
class PortedTaskImplTest {
    ...
    private static Task getTask(final RootStorage storage,
        ...
        if (rootPattern == null) {
            throw new IllegalStateException("Could not resolve root pattern for resource " + resource);
        }
    ...
    private static java.util.Map<java.util.UUID, Pattern> indexPatterns(final java.util.Set<Pattern> patterns) {
        final java.util.Map<java.util.UUID, Pattern> result = new java.util.HashMap<>();
