...
dependencies {
    ...
    include("org.ojalgo:ojalgo:${property("ojalgoVersion")}")

    testCompileOnly(libs.apiguardian)
    testCompileOnly("org.ojalgo:ojalgo:${property("ojalgoVersion")}")
    ...
    commonJava("org.ojalgo:ojalgo:${property("ojalgoVersion")}")
}
